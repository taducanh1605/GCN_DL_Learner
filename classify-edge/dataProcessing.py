...
#=========================================================
def word_embedding_ind(embeding_file, classes, onto):
    dim = 300
    embeddings = KeyedVectors.load_word2vec_format(embeding_file, binary=True)
    node_embeding = np.zeros((len(classes),dim))
...
#=========================================================
def word_embedding_concept_ind(embeding_file, classes, onto):
    dim = 300
    embeddings = KeyedVectors.load_word2vec_format(embeding_file, binary=True)
    node_embeding = np.zeros((len(classes),dim))
    ...
    return node_embeding
#=========================================================
def encodeMatrix(classes, individuals, onto):
    oneHotMatrix = []
    for concept in classes:
        indOfClass = list(onto.search(type = concept))
...
#=========================================================
def label_concept(classes, individuals, onto):
    conceptDict = []
